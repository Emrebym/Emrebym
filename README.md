...
**🧠 [Neuro Memory](https://github.com/Emrebym/neuro-memory)**<br>
Multi-mode memory game with 15 levels & 5 game modes<br>
`React` `Vite` `CSS Animations` `i18n`

</td>
<td width="50%">

**📈 [CoinWtch](https://github.com/Emrebym/CoinWtch)**<br>
Real-time cryptocurrency market watcher<br>
...
**💼 [Job Board](https://github.com/Emrebym/Job-Board)**<br>
Job listing & application platform<br>
`TypeScript` `Full-Stack`

</td>
<td width="50%">

**🏠 [Estate App](https://github.com/Emrebym/Estate-App)**<br>
Real estate listing application<br>
`JavaScript` `REST API`
...
**⌨️ [Typer](https://github.com/Emrebym/Typer)**<br>
Typing speed test & practice tool<br>
`JavaScript` `DOM Manipulation`

</td>
<td width="50%">

**🌤️ [Weather](https://github.com/Emrebym/weather)**<br>
